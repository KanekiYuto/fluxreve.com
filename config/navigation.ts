...
export const headerNavigation: HeaderNavEntry[] = [
  ...
  { type: 'link', name: 'ai-generator', href: '/ai-generator' },
  {
    ...
    items: [
      ...
      { name: 'gpt-image-15', href: '/gpt-image-15', icon: 'sparkles', description: 'gptImage15Desc' },
...
export const navigationGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'gpt-image-15', href: '/gpt-image-15', icon: 'sparkles' },
...
export const footerSections: FooterSection[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { name: 'gpt-image-15', href: '/gpt-image-15' },
